...
public class WeiOrgNetFragment extends BaseFragment implements AdvancedWebView.Listener, WeiOrgNetFragmentBack
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        pulltoRefreshScrollView = (PullToRefreshScrollView)rootView.findViewById(R.id.pulltoRefreshScrollView);
    ...
    {
        /*
         * TODO: In the Android M Preview release, checking if the platform is M is done through the codename, not the
         * version code. Once the API has been finalised, the following check should be used:
         */
